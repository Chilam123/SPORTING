 ...
 *  封装好的网络请求类
 *  用法：
 *  请求：实例化一个Request<你的类型> request=Nohttp.create方法(自己选)
 *       CallServer.getRequestInstance().add()把request扔进去
 *  回调： 类 implements HttpListener<你请求数据的类型>
 *        重写方法onSucceed() 和onFailed()
 *  参考nohttpSample
 */
