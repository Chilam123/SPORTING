...
public class MyPublishSportActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_publish_sport);
        ...
        imageviewBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyPublishSportActivity.this.finish();
            }
        });
    ...
    private void initSportsListView() {
        aListView = (ListView) findViewById(R.id.listview_mypulishsport);
    ...
    private void initAllSport() {
        ...
        NetRequestConstant.requestUrl = NetUrlConstant.MYPUBLISESPORTURL;
            ...
            public void preccess(Object res, boolean flag) {
                ...
                if (res != null) {
                    try {
                        ...
                        sportAllAdapter = new SportAllAdapter(MyPublishSportActivity.this, allList, handler);
                    ...
                    if (res != null) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(MyPublishSportActivity.this, "参加成功！",
                                        Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(MyPublishSportActivity.this, "参加失败！",
                                        Toast.LENGTH_SHORT).show();
                            }
